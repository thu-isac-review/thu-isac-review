export let state = {
    ...
    filterSelections: {
        term: new Set(), dept: new Set(), grade: new Set(), resp_dept: new Set(), course: new Set(), period: new Set(), 
        inst_raw: new Set(), proof: new Set(), employment: new Set(), allowance: new Set(), payment_type: new Set(), 
        insurance: new Set(), is_moe_compliant: new Set()
    },
    filterDefinitions: [
...
export function resetInternRecordState() {
    ...
    state = {
        ...
        filterSelections: { term: new Set(), dept: new Set(), grade: new Set(), resp_dept: new Set(), course: new Set(), period: new Set(), inst_raw: new Set(), proof: new Set(), employment: new Set(), allowance: new Set(), payment_type: new Set(), insurance: new Set(), is_moe_compliant: new Set() },
