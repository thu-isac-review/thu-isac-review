export let state = {
    ...
    currentAcademicYear: '', // 🌟 全域學年度
    tableColumns: [
        { index: 1, label: '學期', visible: true, disableToggle: true, width: 80 },
        { index: 2, label: '學號', visible: true, disableToggle: true, width: 110 },
        { index: 3, label: '姓名', visible: true, disableToggle: true, width: 100 },
        { index: 4, label: '學系', visible: true, disableToggle: true, width: 90 },
        { index: 5, label: '年級', visible: true, width: 80 },
        { index: 6, label: '機構名稱', visible: true, width: 280 },
        { index: 7, label: '修習課程', visible: true, width: 240 },
        ...
        { index: 14, label: '投保情形', visible: true, width: 120 },
        ...
        { index: 19, label: '補助經費來源', visible: false, width: 140 },
        { index: 20, label: '實習機會來源', visible: false, width: 120 },
        { index: 21, label: '實習職缺類型', visible: false, width: 100 },
        { index: 22, label: '符合校庫填報', visible: true, width: 120 },
        { index: 23, label: '不符合校庫填報原因', visible: true, width: 180 },
        { index: 24, label: '填報系所', visible: true, width: 90 }
    ],
    filterSelections: {
